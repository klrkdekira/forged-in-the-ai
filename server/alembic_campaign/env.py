...
def run_migrations_online() -> None:
    ...
    with connectable.connect() as connection:
        # ADR-0005: WAL mode on every file this touches; migrations run per
        # file on open, so this is where a freshly created file first sets it.
        # Committed on its own: SQLite rejects changing journal_mode inside
        # the transaction Alembic is about to open.
